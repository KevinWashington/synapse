  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[3/4] bg-gray-100 dark:bg-gray-900 flex items-center justify-center">
        <FileIcon
          className={`w-16 h-16 ${artigo.hasPdf ? "text-blue-500" : "text-gray-400"
            }`}
        />
        ...
        {artigo.aiRelevanceScore !== undefined && artigo.aiRelevanceScore !== null && (
          <div className="absolute bottom-2 right-2 z-10">
            <div
              className={`flex items-center gap-1 px-1.5 py-0.5 rounded-full text-[10px] font-bold shadow-sm border ${artigo.aiSuggestedStatus === "incluido"
                ? "bg-green-50 text-green-700 border-green-200"
                : "bg-red-50 text-red-700 border-red-200"
                }`}
              title={`IA Sugere: ${artigo.aiSuggestedStatus === "incluido" ? "Incluir" : "Excluir"
                }\nJustificativa: ${artigo.aiEvaluation}`}
            >
