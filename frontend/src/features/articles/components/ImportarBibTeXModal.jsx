    ...
    try {
      ...
      for (const artigo of artigos) {
        const articleData = {
          ...
          year: parseInt(artigo.year), // Converter para número
          journal: artigo.journal || "Conferência/Periódico não especificado",
        ...
        // Usar createArticleJson para enviar JSON em vez de FormData
        await articleService.createArticleJson(projectId, articleData);
      }

      toast.success(`${artigos.length} artigo(s) importado(s) com sucesso!`);
      onSuccess();
      handleClose();
    } catch (err) {
