...
export function SlidePanel({
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed inset-0 z-50 bg-black/30 backdrop-blur-[2px] transition-opacity",
          isOpen
            ? "opacity-100 pointer-events-auto"
            : "opacity-0 pointer-events-none"
        )}
        style={{ transition: "opacity var(--syn-transition)" }}
        onClick={onClose}
        aria-hidden="true"
      />
      ...
      <div
        ...
        aria-label={title}
        className={cn(
          "fixed top-0 right-0 z-50 h-full flex flex-col w-full",
          width,
        ...
        style={{ transition: "transform var(--syn-transition)" }}
      >
        {/* Header */}
